...
import styles from "@styles/AiPlayModal.module.css";
import SelectField from "@components/SelectField";
import type { db } from "play";

interface AiPlayModalProps {
  open: boolean;
  generating: boolean;
  error: string;
  categories: db.PlayCategory[];
  initialCategoryId: string;
  onClose: () => void;
  onGenerate: (prompt: string, categoryId: string) => void;
}

export default function AiPlayModal({
  open,
  generating,
  error,
  categories,
      ...
      >
        <header className={styles.header}>
          ...
          <div>
            ...
            <h2 id="ai-play-title">Gerar Play! com IA</h2>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={submit}>
          <label className={styles.categoryField}>
            ...
            <SelectField
              value={categoryId}
              disabled={generating}
              aria-label="Categoria do Play! gerado por IA"
          ...
          <label className={styles.promptField}>
            ...
            <textarea
              ...
              maxLength={2000}
              disabled={generating}
              placeholder="Ex.: Crie um Play! de nível intermediário sobre o sistema solar para alunos do 7º ano."
